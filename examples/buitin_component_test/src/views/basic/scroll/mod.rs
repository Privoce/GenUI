...
live_design! {
    ...
    use crate::views::basic::scroll::usage::*;
    // use crate::views::basic::scroll::animate::*;
    use crate::views::basic::scroll::event::*;
    BOLD_FONT = dep("crate://self/resources/OPPOSans-Bold.ttf");
    pub ScrollPage = {{ScrollPage}}{
        height: Fill,
        width: Fill,
        flow: Down,
