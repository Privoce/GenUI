...
impl Widget for WindowPage {
    ...
    fn handle_event(&mut self, cx: &mut Cx, event: &Event, scope: &mut Scope) {
        ...
        // let close = self.gbutton(id!(close));
        // let full = self.gbutton(id!(full));
        // let min = self.gbutton(id!(min));
        // let max = self.gbutton(id!(max));
        // if min.clicked(&actions).is_some() {
        //     // active_minimize(self.widget_uid(), &scope.path, cx);
        //     cx.widget_action(self.widget_uid(),&scope.path, MyE::Min);
        // }
        // if max.clicked(&actions).is_some() {
        //     active_maximize(self.widget_uid(), &scope.path, cx);
        // }
        // if full.clicked(&actions).is_some() {
        //     active_fullscreen(self.widget_uid(), &scope.path, cx);
        // }
        // if close.clicked(&actions).is_some() {
        //     active_close(self.widget_uid(), &scope.path, cx);
        // }
    }
}
