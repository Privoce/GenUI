...
pub enum Props {
    ...
    TextVisible(bool),
    Size(F32),
    CheckboxBackgroundColor(MakepadColor),
    CheckboxBackgroundVisible(bool),
    CheckboxHoverColor(MakepadColor),
    CheckboxSelectedColor(MakepadColor),
    StrokeColor(MakepadColor),
    StrokeHoverColor(MakepadColor),
    StrokeSelectedColor(MakepadColor),
    CheckboxBorderColor(MakepadColor),
    CheckboxBorderWidth(F32),
    Scale(F32),
...
impl TryFrom<(PropsKey, Value)> for Props {
    ...
    fn try_from(value: (PropsKey, Value)) -> Result<Self, Self::Error> {
        match value.0.name() {
            ...
            "checkbox_background_color" => Ok(Props::CheckboxBackgroundColor(
                MakepadColor::try_from((&value.1, None))?,
            )),
            "checkbox_background_visible" => {
                Ok(Props::CheckboxBackgroundVisible(value.1.as_bool()?))
            }
            "checkbox_hover_color" => Ok(Props::CheckboxHoverColor(MakepadColor::try_from((
                &value.1, None,
            ))?)),
            "checkbox_selected_color" => Ok(Props::CheckboxSelectedColor(MakepadColor::try_from(
                (&value.1, None),
            )?)),
            ...
            "checkbox_border_color" => Ok(Props::CheckboxBorderColor(MakepadColor::try_from((
                &value.1, None,
            ))?)),
            "checkbox_border_width" => Ok(Props::CheckboxBorderWidth(value.1.as_f32()?.into())),
            ...
            "checkbox_type" => Ok(Props::CheckboxType(GChooseType::try_from(&value.1)?)),
...
props_to_tokens! {
    ...
    Props::CheckboxBackgroundColor => checkbox_background_color, false,
    Props::CheckboxBackgroundVisible => checkbox_background_visible, false,
    Props::CheckboxHoverColor => checkbox_hover_color, false,
    Props::CheckboxSelectedColor => checkbox_selected_color, false,
    ...
    Props::CheckboxBorderColor => checkbox_border_color, false,
    Props::CheckboxBorderWidth => checkbox_border_width, false,
    ...
    Props::CheckboxType => checkbox_type, false,
